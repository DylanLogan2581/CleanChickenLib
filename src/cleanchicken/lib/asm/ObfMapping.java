...
import cleanchicken.lib.config.ConfigTag;
        ...
        public ObfRemapper() {
            try {
                ...
                if (rawFieldMaps == null)
                    throw new IllegalStateException("cleanchicken.lib.asm.ObfMapping loaded too early. Make sure all references are in or after the asm transformer load stage");
